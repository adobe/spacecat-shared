...
const INDEX_NAME_ALL_IMPORT_URLS_BY_JOB_ID_AND_STATUS = 'spacecat-services-all-import-urls-by-job_id_and_status-dev';
  ...
  return async (request, context) => {
    if (!context.dataAccess) {
      ...
      const {
        ...
        DYNAMO_INDEX_NAME_ALL_IMPORT_URLS_BY_JOB_ID_AND_STATUS = INDEX_NAME_ALL_IMPORT_URLS_BY_JOB_ID_AND_STATUS,
      } = context.env;
