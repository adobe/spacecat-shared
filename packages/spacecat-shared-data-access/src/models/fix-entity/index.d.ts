...
export interface FixEntityCollection extends BaseCollection<FixEntity> {
  ...
  updateFixAndSuggestionsStatus(fixEntityId: string, opportunityId: string, newSuggestionStatus?: string, newFixEntityStatus?: string, options?: object): Promise<{fix: FixEntity, suggestions: Array<Suggestion>}>;
}
