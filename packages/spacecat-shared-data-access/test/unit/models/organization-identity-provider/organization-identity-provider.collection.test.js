...
describe('OrganizationIdentityProviderCollection', () => {
  let instance;
  ...
  const mockRecord = {
    organizationId: '9a6645de-038a-4909-a98f-14e63b2f1bbb',
    providerType: 'IMS',
    externalId: '12345',
  };
  ...
  describe('constructor', () => {
    it('initializes the OrganizationIdentityProviderCollection instance correctly', () => {
