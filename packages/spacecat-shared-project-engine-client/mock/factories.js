 ...
 * (`main_brand: false`); the v2 batch-create route passes `main_brand: true` through in
 * `overrides` when the caller requests the own-brand benchmark (LLMO-7421 — create DOES accept
