...
const VENDORED_SPEC = 'spec/projectengine_swagger_public.yaml';
const SPEC_CHECKSUM = 'spec/projectengine_swagger_public.yaml.sha256';
...
// spec/projectengine_swagger_public.yaml.sha256.
describe('Project Engine foundation: vendored-spec checksum gate (LLMO-5976)', () => {
