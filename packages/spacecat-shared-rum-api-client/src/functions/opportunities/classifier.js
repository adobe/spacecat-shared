...
const PAGE_CLASSIFICATION_MAP = {
  ...
  'volvotrucks.us': {
    'homepage | Homepage': /^https:\/\/www\.volvotrucks\.com\/en-en\/(home\/?)?$/,
    'productlistpage | Trucks Overview': /^https:\/\/www\.volvotrucks\.com\/en-en\/trucks(\/|$|\?)/,
    'productdetailpage | Truck Detail Pages': /^https:\/\/www\.volvotrucks\.com\/en-en\/trucks\/[a-z0-9-]+(\/|$|\?)/,
    'configurator | Truck Builder': /^https:\/\/www\.volvotrucks\.com\/en-en\/truck-builder(\/|$|\?)/,
    'comparevehiclespage | Truck Comparison': /^https:\/\/www\.volvotrucks\.com\/en-en\/trucks\/compare(\/|$|\?)/,
    'services | All Truck Services (Excluding Fleet)': /^https:\/\/www\.volvotrucks\.com\/en-en\/services\/(?!fleet-management)([a-z0-9-]+)?(\/|$)/,
    'fleetpage | Fleet Management Services': /^https:\/\/www\.volvotrucks\.com\/en-en\/services\/fleet-management(\/|$|\/.*)/,
    'events | News & Events': /^https:\/\/www\.volvotrucks\.com\/en-en\/news-stories(\/|$|\/.*)/,
    'dealershippage | Find Dealer': /^https:\/\/www\.volvotrucks\.com\/en-en\/find-dealer(\/|$|\?)/,
    'support | Customer Support': /^https:\/\/www\.volvotrucks\.com\/en-en\/contact-us(\/|$)/,
    'about | About Volvo Trucks': /^https:\/\/www\.volvotrucks\.com\/en-en\/about-us(\/|$|\?)/,
    'legal | Legal / Privacy / Cookies': /^https:\/\/www\.volvotrucks\.com\/en-en\/(privacy|legal-notice|cookie-policy|terms-and-conditions)(\/|$)/,
