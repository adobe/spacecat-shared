...
import { HARD_BLOCK_STATUS_CODES, BOT_CHALLENGE_KEYWORDS } from './waf-probe-utils.js';

// Timeout per agent fetch — aggressive enough to catch stalls without blocking the UI.
export const BOT_PROBE_TIMEOUT_MS = 10000;

// The two user-facing LLM bots most likely to be blocked by UA-based WAF rules.
// These fire when a user actively asks ChatGPT or Perplexity to browse a page — blocking
// them degrades live answer quality, unlike crawler bots (GPTBot, PerplexityBot) which
// affect training data indexing and are a separate concern.
 ...
 *
 * Detection logic (same thresholds as classifyProbeResponse in waf-probe-utils.js):
