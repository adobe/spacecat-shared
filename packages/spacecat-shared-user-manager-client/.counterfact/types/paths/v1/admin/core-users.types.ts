...
import type { handlers_CoreUserWithAPIKey } from "../../../definitions/handlers.CoreUserWithAPIKey.js";
import type { http_server_BasicResponse } from "../../../definitions/http_server.BasicResponse.js";

/**
 * gets core users with ids
 */
export type adminCoreUsersList = (
  $: OmitValueWhenNever<{
    query: adminCoreUsersList_Query;
    querystring: never;
    path: never;
    headers: adminCoreUsersList_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_CoreUserWithAPIKey>;
          };
        };
        examples: {};
      };
...
export type adminCoreUsersList_Query = {
  /**
   * user id
   * @format multi
   */
...
export type adminCoreUsersList_Headers = {
  /**
   * API key
   */
  "API-Key": string;
