...
import type { handlers_userIDsRequest } from "../../../../definitions/handlers.userIDsRequest.js";
import type { handlers_billingStatusResponse } from "../../../../definitions/handlers.billingStatusResponse.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * Returns billing status for multiple users by user IDs
 */
export type adminGetUserBillingStatuses = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: adminGetUserBillingStatuses_Headers;
    cookie: never;
    body: handlers_userIDsRequest;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_billingStatusResponse>;
          };
        };
        examples: {};
      };
...
export type adminGetUserBillingStatuses_Headers = {
  /**
   * Admin API key
   */
  "API-Key": string;
