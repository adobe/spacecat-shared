...
import type { handlers_adminWorkspaceCreateForm } from "../../../definitions/handlers.adminWorkspaceCreateForm.js";
 ...
 */
export type adminWorkspaceChildCreate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: adminWorkspaceChildCreate_Headers;
    cookie: never;
    body: handlers_adminWorkspaceCreateForm;
    context: Context;
...
export type adminWorkspaceChildCreate_Headers = {
  /**
   * Admin API key
   */
  "API-Key": string;
