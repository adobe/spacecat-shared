...
/**
 * Gets you index.html of an spa that is hosted for Admin
 */
export type activationPanelSpa = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: activationPanelSpa_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type activationPanelSpa_Headers = {
  /**
