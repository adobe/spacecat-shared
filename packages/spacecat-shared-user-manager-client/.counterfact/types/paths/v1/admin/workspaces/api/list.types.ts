...
import type { handlers_ActivationPanelWorkspace } from "../../../../../definitions/handlers.ActivationPanelWorkspace.js";
import type { http_server_BasicResponse } from "../../../../../definitions/http_server.BasicResponse.js";

/**
 * returns all first-level workspaces (children of the root) including their limits as well as the full hierarchy of their descendant workspaces with limits
 */
export type activationPanelGetAllWorkspaces = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: activationPanelGetAllWorkspaces_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_ActivationPanelWorkspace>;
          };
        };
        examples: {};
      };
...
export type activationPanelGetAllWorkspaces_Headers = {
  /**
