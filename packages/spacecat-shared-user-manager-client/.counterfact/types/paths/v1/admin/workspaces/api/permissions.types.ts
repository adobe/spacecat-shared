...
import type { handlers_ActivationPanelPermissionsResponse } from "../../../../../definitions/handlers.ActivationPanelPermissionsResponse.js";
 ...
 */
export type activationPanelWorkspacePermissions = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: activationPanelWorkspacePermissions_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_ActivationPanelPermissionsResponse;
          };
        };
        examples: {};
      };
...
export type activationPanelWorkspacePermissions_Headers = {
  /**
