...
import type { handlers_ActivationPanelWorkspaceMetadata } from "../../../../../definitions/handlers.ActivationPanelWorkspaceMetadata.js";
import type { http_server_BasicResponse } from "../../../../../definitions/http_server.BasicResponse.js";

/**
 * retrieves all workspaces with basic metadata fields: ID, Title, Icon, and ParentID (made for Activation Panel)
 */
export type activationPanelAllWorkspacesFind = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: activationPanelAllWorkspacesFind_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_ActivationPanelWorkspaceMetadata>;
          };
        };
        examples: {};
      };
...
export type activationPanelAllWorkspacesFind_Headers = {
  /**
