...
/**
 * Get report for SMB projects migration for given workspaceID as comma separated csv
 */
export type activationPanelProjectsMigrationReport = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: activationPanelProjectsMigrationReport_Path;
    headers: activationPanelProjectsMigrationReport_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type activationPanelProjectsMigrationReport_Path = {
  /**
...
export type activationPanelProjectsMigrationReport_Headers = {
  /**
