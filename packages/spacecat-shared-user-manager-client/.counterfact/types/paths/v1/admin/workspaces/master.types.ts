...
import type { handlers_adminWorkspaceUpsertForm } from "../../../../definitions/handlers.adminWorkspaceUpsertForm.js";
 ...
 */
export type adminWorkspaceCreateMaster = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: adminWorkspaceCreateMaster_Headers;
    cookie: never;
    body: handlers_adminWorkspaceUpsertForm;
    context: Context;
...
export type adminWorkspaceCreateMaster_Headers = {
  /**
   * Admin API key
   */
  "API-Key": string;
