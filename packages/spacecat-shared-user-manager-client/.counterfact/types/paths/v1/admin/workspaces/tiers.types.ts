...
import type { handlers_tiersResponse } from "../../../../definitions/handlers.tiersResponse.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * this API returns list of available tiers
 */
export type activationPanelTiersList = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: activationPanelTiersList_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type activationPanelTiersList_Headers = {
  /**
