 ...
 */
export type adminEsProjectDelete = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: adminEsProjectDelete_Path;
    headers: adminEsProjectDelete_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type adminEsProjectDelete_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type adminEsProjectDelete_Headers = {
  /**
   * API key
   */
  "API-Key": string;
