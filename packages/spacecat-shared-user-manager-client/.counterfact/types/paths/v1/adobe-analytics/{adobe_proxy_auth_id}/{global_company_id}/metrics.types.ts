...
/**
 * Deprecated: use GET /v2/adobe-analytics/metrics with credential_id, global_company_id, rsid in query instead.
 * @deprecated
 */
export type adobeAnalyticsGetMetrics = (
  $: OmitValueWhenNever<{
    query: adobeAnalyticsGetMetrics_Query;
    querystring: never;
    path: adobeAnalyticsGetMetrics_Path;
    headers: adobeAnalyticsGetMetrics_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type adobeAnalyticsGetMetrics_Query = {
  /**
   * Report Suite ID
   */
  rsid: string;
...
export type adobeAnalyticsGetMetrics_Path = {
  /**
...
export type adobeAnalyticsGetMetrics_Headers = {
  /**
   * JWT Token
   */
