...
import type { handlers_ReportSuite } from "../../../../../definitions/handlers.ReportSuite.js";

/**
 * Deprecated: use GET /v2/adobe-analytics/reportsuites with credential_id and global_company_id in query instead.
 * @deprecated
 */
export type adobeAnalyticsGetReportSuites = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: adobeAnalyticsGetReportSuites_Path;
    headers: adobeAnalyticsGetReportSuites_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_ReportSuite>;
          };
        };
        examples: {};
      };
...
export type adobeAnalyticsGetReportSuites_Path = {
  /**
...
export type adobeAnalyticsGetReportSuites_Headers = {
  /**
   * JWT Token
   */
