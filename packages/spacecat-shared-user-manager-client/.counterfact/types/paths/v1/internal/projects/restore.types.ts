...
/**
 * restore deleted project on enterprise
 */
export type internalRestoreProject = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: internalRestoreProject_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalRestoreProject_Headers = {
  /**
   * API key
   */
  "API-Key": string;
