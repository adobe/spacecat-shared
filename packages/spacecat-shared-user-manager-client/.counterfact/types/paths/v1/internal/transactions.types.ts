...
import type { handlers_TransactionsCreateForm } from "../../../definitions/handlers.TransactionsCreateForm.js";
...
export type transactionCreate = (
  $: OmitValueWhenNever<{
    ...
    querystring: never;
    path: never;
    headers: transactionCreate_Headers;
    cookie: never;
    body: handlers_TransactionsCreateForm;
    context: Context;
...
export type transactionCreate_Headers = {
  /**
   * API key
   */
  "API-Key": string;
