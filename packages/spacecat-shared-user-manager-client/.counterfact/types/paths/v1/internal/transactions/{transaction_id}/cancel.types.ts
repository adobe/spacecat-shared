...
import type { handlers_TransactionsCancelForm } from "../../../../../definitions/handlers.TransactionsCancelForm.js";
...
export type transactionCancel = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: transactionCancel_Path;
    headers: transactionCancel_Headers;
    cookie: never;
    body: handlers_TransactionsCancelForm;
    context: Context;
...
export type transactionCancel_Path = {
  /**
   * transaction id
   */
...
export type transactionCancel_Headers = {
  /**
   * API key
   */
  "API-Key": string;
