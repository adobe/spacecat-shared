...
import type { handlers_InternalESUsersList } from "../../../../definitions/handlers.InternalESUsersList.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * An internal API to find all ES users
 */
export type internalAllEsUsers = (
  $: OmitValueWhenNever<{
    query: internalAllEsUsers_Query;
    querystring: never;
    path: never;
    headers: internalAllEsUsers_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_InternalESUsersList;
          };
        };
        examples: {};
      };
...
export type internalAllEsUsers_Query = {
  /**
   * page number
   * @default 1
   */
...
export type internalAllEsUsers_Headers = {
  /**
   * API key
   */
  "API-Key": string;
