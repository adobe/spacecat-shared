...
/**
 * gets limits for all workspaces
 */
export type internalWorkspacesLimits = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: internalWorkspacesLimits_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalWorkspacesLimits_Headers = {
  /**
   * API key
   */
  "API-Key": string;
