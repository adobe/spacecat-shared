...
/**
 * gets batch workspace members
 */
export type internalBatchWorkspacesMembers = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: internalBatchWorkspacesMembers_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalBatchWorkspacesMembers_Headers = {
  /**
   * API key
   */
  "API-Key": string;
