...
import type { page_engine_backend_internal_usermanager_core_domain_SOXWorkspace } from "../../../../definitions/page-engine-backend_internal_usermanager_core_domain.SOXWorkspace.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * gets the list of all workspaces for SOX compliance
 */
export type internalWorkspacesSoxList = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: internalWorkspacesSoxList_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<
              Array<page_engine_backend_internal_usermanager_core_domain_SOXWorkspace>
            >;
          };
        };
        examples: {};
...
export type internalWorkspacesSoxList_Headers = {
  /**
   * API key
   */
  "API-Key": string;
