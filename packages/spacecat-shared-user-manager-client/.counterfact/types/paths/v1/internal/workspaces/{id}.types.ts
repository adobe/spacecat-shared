...
import type { handlers_internalWorkspace } from "../../../../definitions/handlers.internalWorkspace.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * internal API to get workspace by id.
 */
export type internalWorkspaceGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: internalWorkspaceGet_Path;
    headers: internalWorkspaceGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_internalWorkspace;
          };
        };
        examples: {};
      };
...
export type internalWorkspaceGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalWorkspaceGet_Headers = {
  /**
   * API key
   */
  "API-Key": string;
