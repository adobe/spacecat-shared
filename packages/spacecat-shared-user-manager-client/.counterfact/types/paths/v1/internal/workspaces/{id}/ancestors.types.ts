 ...
 */
export type internalWorkspacesAncestor = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: internalWorkspacesAncestor_Path;
    headers: internalWorkspacesAncestor_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalWorkspacesAncestor_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalWorkspacesAncestor_Headers = {
  /**
   * API key
   */
  "API-Key": string;
