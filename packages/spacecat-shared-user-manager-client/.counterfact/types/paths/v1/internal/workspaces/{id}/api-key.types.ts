 ...
 */
export type internalWorkspaceOwnerApiKeyGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: internalWorkspaceOwnerApiKeyGet_Path;
...
export type internalWorkspaceOwnerApiKeyGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalWorkspaceOwnerApiKeyGet_Headers = {
  /**
   * API key
   */
  "API-Key": string;
