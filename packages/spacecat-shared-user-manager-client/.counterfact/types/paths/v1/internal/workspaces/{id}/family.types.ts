...
/**
 * an admin API to get a list of all children, grand children workspaces
 */
export type internalWorkspacesFamily = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: internalWorkspacesFamily_Path;
    headers: internalWorkspacesFamily_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalWorkspacesFamily_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalWorkspacesFamily_Headers = {
  /**
   * API key
   */
  "API-Key": string;
