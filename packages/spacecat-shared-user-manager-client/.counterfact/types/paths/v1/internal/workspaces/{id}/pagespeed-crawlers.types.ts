...
import type { handlers_pagespeedCrawlersInternalListResponse } from "../../../../../definitions/handlers.pagespeedCrawlersInternalListResponse.js";
import type { http_server_BasicResponse } from "../../../../../definitions/http_server.BasicResponse.js";

/**
 * gets a list pagespeed crawlers that belong to a workspace
 */
export type pagespeedInternalList = (
  $: OmitValueWhenNever<{
    query: pagespeedInternalList_Query;
    querystring: never;
    path: pagespeedInternalList_Path;
    headers: pagespeedInternalList_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_pagespeedCrawlersInternalListResponse;
          };
        };
        examples: {};
      };
...
export type pagespeedInternalList_Query = {
  /**
   * page number
   */
  page?: number;
...
export type pagespeedInternalList_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type pagespeedInternalList_Headers = {
  /**
   * API key
   */
  "API-Key": string;
