...
import type { handlers_pagespeedInternalKeywordsListResponse } from "../../../../../../../definitions/handlers.pagespeedInternalKeywordsListResponse.js";
import type { http_server_BasicResponse } from "../../../../../../../definitions/http_server.BasicResponse.js";

/**
 * gets a list of keywords of pagespeed crawler by its id.
 */
export type pagespeedInternalKeywordsList = (
  $: OmitValueWhenNever<{
    query: pagespeedInternalKeywordsList_Query;
    querystring: never;
    path: pagespeedInternalKeywordsList_Path;
    headers: pagespeedInternalKeywordsList_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_pagespeedInternalKeywordsListResponse;
          };
        };
        examples: {};
      };
...
export type pagespeedInternalKeywordsList_Query = {
  /**
   * page number
   */
  page?: number;
...
export type pagespeedInternalKeywordsList_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type pagespeedInternalKeywordsList_Headers = {
  /**
   * API key
   */
  "API-Key": string;
