...
/**
 * gets a list of urls of pagespeed crawler by its id.
 */
export type pagespeedInternalUrlsList = (
  $: OmitValueWhenNever<{
    query: pagespeedInternalUrlsList_Query;
    querystring: never;
    path: pagespeedInternalUrlsList_Path;
    headers: pagespeedInternalUrlsList_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type pagespeedInternalUrlsList_Query = {
  /**
   * page number
   */
  page?: number;
...
export type pagespeedInternalUrlsList_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type pagespeedInternalUrlsList_Headers = {
  /**
   * API key
   */
  "API-Key": string;
