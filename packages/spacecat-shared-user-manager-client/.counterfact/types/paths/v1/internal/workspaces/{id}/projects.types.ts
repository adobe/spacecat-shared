 ...
 */
export type projectListGet = (
  $: OmitValueWhenNever<{
    query: projectListGet_Query;
    querystring: never;
    path: projectListGet_Path;
...
export type projectListGet_Query = {
  /**
   * page number
   */
  page?: number;
...
export type projectListGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectListGet_Headers = {
  /**
   * API key
   */
  "API-Key": string;
