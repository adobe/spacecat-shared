 ...
 */
export type projectTargetListGetInternal = (
  $: OmitValueWhenNever<{
    query: projectTargetListGetInternal_Query;
    querystring: never;
    path: projectTargetListGetInternal_Path;
    headers: projectTargetListGetInternal_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type projectTargetListGetInternal_Query = {
  /**
   * live
   */
  live?: boolean;
...
export type projectTargetListGetInternal_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectTargetListGetInternal_Headers = {
  /**
   * API key
   */
  "API-Key": string;
