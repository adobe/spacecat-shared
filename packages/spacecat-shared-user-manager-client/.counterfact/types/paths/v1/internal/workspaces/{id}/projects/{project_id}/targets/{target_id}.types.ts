 ...
 * gets target details
 */
export type internalProjectTargetDetails = (
  $: OmitValueWhenNever<{
    query: internalProjectTargetDetails_Query;
    querystring: never;
    path: internalProjectTargetDetails_Path;
    headers: internalProjectTargetDetails_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalProjectTargetDetails_Query = {
  /**
   * live
   */
  live?: boolean;
...
export type internalProjectTargetDetails_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalProjectTargetDetails_Headers = {
  /**
   * API key
   */
  "API-Key": string;
