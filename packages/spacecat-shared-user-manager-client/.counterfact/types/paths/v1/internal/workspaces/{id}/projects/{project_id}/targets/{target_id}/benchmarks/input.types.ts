...
import type { handlers_InternalBenchmark } from "../../../../../../../../../../definitions/handlers.InternalBenchmark.js";
import type { http_server_BasicResponse } from "../../../../../../../../../../definitions/http_server.BasicResponse.js";

/**
 * this API lists internal benchmarks of a project
 */
export type internalBenchmarksInput = (
  $: OmitValueWhenNever<{
    query: internalBenchmarksInput_Query;
    querystring: never;
    path: internalBenchmarksInput_Path;
    headers: internalBenchmarksInput_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_InternalBenchmark>;
          };
        };
        examples: {};
      };
...
export type internalBenchmarksInput_Query = {
  /**
   * benchmark ids
   */
  ids: string;
...
export type internalBenchmarksInput_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalBenchmarksInput_Headers = {
  /**
   * API key
   */
  "API-Key": string;
