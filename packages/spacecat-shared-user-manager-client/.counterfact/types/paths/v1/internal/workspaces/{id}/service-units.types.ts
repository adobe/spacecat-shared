...
import type { handlers_getServiceUnitsResponse } from "../../../../../definitions/handlers.getServiceUnitsResponse.js";
import type { http_server_BasicResponse } from "../../../../../definitions/http_server.BasicResponse.js";

/**
 * gets service units
 */
export type serviceUnitsGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: serviceUnitsGet_Path;
    headers: serviceUnitsGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_getServiceUnitsResponse;
          };
        };
        examples: {};
      };
 ...
 * sets service units
 */
export type serviceUnitsSet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: serviceUnitsSet_Path;
...
export type serviceUnitsGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type serviceUnitsGet_Headers = {
  /**
   * API key
   */
  "API-Key": string;
...
export type serviceUnitsSet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type serviceUnitsSet_Headers = {
  /**
   * API key
   */
  "API-Key": string;
