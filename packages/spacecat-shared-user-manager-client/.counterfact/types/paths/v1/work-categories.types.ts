...
import type { handlers_WorkCategory } from "../../definitions/handlers.WorkCategory.js";
...
export type workCategories = (
  $: OmitValueWhenNever<{
    ...
    querystring: never;
    path: never;
    headers: workCategories_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_WorkCategory>;
          };
        };
        examples: {};
      };
...
export type workCategories_Headers = {
  /**
   * JWT Token
   */
