...
/**
 * gets a lightweight list of workspaces owned by the user
 */
export type workspacesLightList = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: workspacesLightList_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_workspaceLightResponse>;
          };
        };
        examples: {};
      };
...
export type workspacesLightList_Headers = {
  /**
   * JWT Token
   */
