...
/**
 * gets workspace total resources in a cool new way
 */
export type workspaceResourcesFindAll = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: workspaceResourcesFindAll_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspaceResourcesFindAll_Headers = {
  /**
   * JWT Token
   */
