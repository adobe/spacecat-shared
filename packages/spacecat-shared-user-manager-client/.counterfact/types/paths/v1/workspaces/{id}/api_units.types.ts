...
import type { handlers_APIUnitsResponse } from "../../../../definitions/handlers.APIUnitsResponse.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * gets API units of a workspace
 */
export type workspaceApiUnitsGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspaceApiUnitsGet_Path;
    headers: workspaceApiUnitsGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_APIUnitsResponse;
          };
        };
        examples: {};
      };
...
export type workspaceApiUnitsGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspaceApiUnitsGet_Headers = {
  /**
   * JWT Token
   */
