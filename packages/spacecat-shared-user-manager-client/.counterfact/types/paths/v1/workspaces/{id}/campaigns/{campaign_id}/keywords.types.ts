...
/**
 * gets keywords that belong to a campaign.
 */
export type workspacesCampaignKeywordsList = (
  $: OmitValueWhenNever<{
    query: workspacesCampaignKeywordsList_Query;
    querystring: never;
    path: workspacesCampaignKeywordsList_Path;
    headers: workspacesCampaignKeywordsList_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspacesCampaignKeywordsList_Query = {
  /**
   * page number
   */
  page?: number;
...
export type workspacesCampaignKeywordsList_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspacesCampaignKeywordsList_Headers = {
  /**
   * API key
   */
  "API-Key": string;
