...
/**
 * an API to get a list of all children, grand children workspaces which belong to a workspace
 */
export type workspacesFamily = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspacesFamily_Path;
    headers: workspacesFamily_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspacesFamily_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspacesFamily_Headers = {
  /**
   * JWT Token
   */
