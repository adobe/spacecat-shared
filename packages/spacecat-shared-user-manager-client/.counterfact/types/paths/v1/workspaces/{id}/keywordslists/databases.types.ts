...
import type { handlers_KeywordsListDatabasesResponse } from "../../../../../definitions/handlers.KeywordsListDatabasesResponse.js";
import type { http_server_BasicResponse } from "../../../../../definitions/http_server.BasicResponse.js";

/**
 * Gets list of databases of keywords
 */
export type keywordslistsDatabasesGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: keywordslistsDatabasesGet_Path;
    headers: keywordslistsDatabasesGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_KeywordsListDatabasesResponse;
          };
        };
        examples: {};
      };
...
export type keywordslistsDatabasesGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type keywordslistsDatabasesGet_Headers = {
  /**
   * JWT Token
   */
