...
import type { handlers_GetLimitsResponse } from "../../../../definitions/handlers.GetLimitsResponse.js";
 ...
 * @deprecated
 */
export type limitsGet = (
  $: OmitValueWhenNever<{
    query: limitsGet_Query;
    querystring: never;
    path: limitsGet_Path;
    headers: limitsGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_GetLimitsResponse;
          };
        };
        examples: {};
      };
...
export type limitsGet_Query = {
  /**
   * set true if you want the master workspace's limits
   */
  master?: boolean;
};

export type limitsGet_Path = {
  /**
   * workspace id
   */
  id: string;
