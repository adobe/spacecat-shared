...
/**
 * gets workspace's parent details matching with id
 */
export type workspaceDetailsParent = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspaceDetailsParent_Path;
    headers: workspaceDetailsParent_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspaceDetailsParent_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspaceDetailsParent_Headers = {
  /**
   * JWT Token
   */
