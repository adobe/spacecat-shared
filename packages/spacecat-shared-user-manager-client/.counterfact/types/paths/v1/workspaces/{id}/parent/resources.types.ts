...
/**
 * gets workspace's master workspace resources resources matching with id
 */
export type workspaceResourcesMaster = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspaceResourcesMaster_Path;
...
export type workspaceResourcesMaster_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspaceResourcesMaster_Headers = {
  /**
   * JWT Token
   */
