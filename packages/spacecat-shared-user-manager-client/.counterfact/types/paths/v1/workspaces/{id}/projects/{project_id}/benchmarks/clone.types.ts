 ...
 */
export type workspacesCloneBenchmarksTags = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspacesCloneBenchmarksTags_Path;
    headers: workspacesCloneBenchmarksTags_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspacesCloneBenchmarksTags_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspacesCloneBenchmarksTags_Headers = {
  /**
   * JWT Token
   */
