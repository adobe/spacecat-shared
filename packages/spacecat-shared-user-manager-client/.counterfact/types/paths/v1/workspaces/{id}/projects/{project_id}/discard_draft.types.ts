...
/**
 * discards draft projects and copies back live version
 */
export type discardDraftProject = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: discardDraftProject_Path;
    headers: discardDraftProject_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type discardDraftProject_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type discardDraftProject_Headers = {
  /**
   * JWT Token
   */
