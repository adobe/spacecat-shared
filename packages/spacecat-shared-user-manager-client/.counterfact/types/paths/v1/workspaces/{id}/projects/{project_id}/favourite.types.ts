...
import type { handlers_projectFavouriteSetForm } from "../../../../../../definitions/handlers.projectFavouriteSetForm.js";
import type { http_server_BasicResponse } from "../../../../../../definitions/http_server.BasicResponse.js";

/**
 * API to set project as favourite
 */
export type setProjectFavourite = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: setProjectFavourite_Path;
    headers: setProjectFavourite_Headers;
    cookie: never;
    body: handlers_projectFavouriteSetForm;
    context: Context;
...
export type setProjectFavourite_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type setProjectFavourite_Headers = {
  /**
   * JWT Token
   */
