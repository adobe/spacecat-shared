 ...
 */
export type crawlerLimitsGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: crawlerLimitsGet_Path;
    headers: crawlerLimitsGet_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type crawlerLimitsGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type crawlerLimitsGet_Headers = {
  /**
   * JWT Token
   */
