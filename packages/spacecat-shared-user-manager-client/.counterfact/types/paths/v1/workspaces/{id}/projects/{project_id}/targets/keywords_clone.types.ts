 ...
 */
export type workspacesCloneKeywordsTags = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspacesCloneKeywordsTags_Path;
    headers: workspacesCloneKeywordsTags_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspacesCloneKeywordsTags_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspacesCloneKeywordsTags_Headers = {
  /**
   * JWT Token
   */
