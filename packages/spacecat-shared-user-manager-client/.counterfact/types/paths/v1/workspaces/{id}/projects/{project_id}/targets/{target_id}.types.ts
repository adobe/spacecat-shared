 ...
 * gets target details
 */
export type projectTargetDetails = (
  $: OmitValueWhenNever<{
    query: projectTargetDetails_Query;
    querystring: never;
    path: projectTargetDetails_Path;
    headers: projectTargetDetails_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type projectTargetDetails_Query = {
  /**
   * live
   */
  live?: boolean;
...
export type projectTargetDetails_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectTargetDetails_Headers = {
  /**
   * JWT Token
   */
