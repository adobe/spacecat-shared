...
import type { handlers_benchmarkBulkUpdateForm } from "../../../../../../../../../definitions/handlers.benchmarkBulkUpdateForm.js";
...
/**
 * this API lets client bulk update benchmarks of a project
 */
export type projectBulkUpdateBenchmarks = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectBulkUpdateBenchmarks_Path;
    headers: projectBulkUpdateBenchmarks_Headers;
    cookie: never;
    body: handlers_benchmarkBulkUpdateForm;
    context: Context;
...
export type projectBulkUpdateBenchmarks_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectBulkUpdateBenchmarks_Headers = {
  /**
   * JWT Token
   */
