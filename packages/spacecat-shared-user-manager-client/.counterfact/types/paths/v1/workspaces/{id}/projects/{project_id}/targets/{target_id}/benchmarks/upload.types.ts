...
/**
 * this API uploads benchmarks of a project from csv/xlsx file.
 * First element is supposed to be URL
 * whereas second element is supposed to be color, other elements are ignored.
 */
export type projectUploadBenchmarks = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectUploadBenchmarks_Path;
    headers: projectUploadBenchmarks_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type projectUploadBenchmarks_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectUploadBenchmarks_Headers = {
  /**
   * JWT Token
   */
