...
import type { handlers_benchmarkUpdateForm } from "../../../../../../../../../definitions/handlers.benchmarkUpdateForm.js";
...
/**
 * this API lets client updates a benchmark of a project
 */
export type projectUpdateBenchmarks = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectUpdateBenchmarks_Path;
    headers: projectUpdateBenchmarks_Headers;
    cookie: never;
    body: handlers_benchmarkUpdateForm;
    context: Context;
...
export type projectUpdateBenchmarks_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectUpdateBenchmarks_Headers = {
  /**
   * JWT Token
   */
