...
/**
 * gets metrics of keywords, data is fetched from elements data source
 */
export type keywordsMetrics = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: keywordsMetrics_Path;
    headers: keywordsMetrics_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type keywordsMetrics_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type keywordsMetrics_Headers = {
  /**
   * JWT Token
   */
