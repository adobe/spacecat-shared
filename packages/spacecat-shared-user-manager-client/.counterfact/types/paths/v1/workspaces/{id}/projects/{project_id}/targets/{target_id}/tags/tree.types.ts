 ...
 */
export type projectTagsTree = (
  $: OmitValueWhenNever<{
    query: projectTagsTree_Query;
    querystring: never;
    path: projectTagsTree_Path;
    headers: projectTagsTree_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type projectTagsTree_Query = {
  /**
   * tag id
   */
  tag_id: number;
...
export type projectTagsTree_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectTagsTree_Headers = {
  /**
   * JWT Token
   */
