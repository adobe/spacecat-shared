 ...
 */
export type serviceCreditsTransactionGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: serviceCreditsTransactionGet_Path;
    headers: serviceCreditsTransactionGet_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type serviceCreditsTransactionGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type serviceCreditsTransactionGet_Headers = {
  /**
   * JWT Token
   */
