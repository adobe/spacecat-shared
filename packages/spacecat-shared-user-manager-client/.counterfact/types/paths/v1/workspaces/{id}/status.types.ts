...
import type { handlers_WorkspaceCheckResponse } from "../../../../definitions/handlers.WorkspaceCheckResponse.js";
import type { http_server_BasicResponse } from "../../../../definitions/http_server.BasicResponse.js";

/**
 * THe status must be "not ready", "created" or "error"
 */
export type workspacesStatusGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspacesStatusGet_Path;
    headers: workspacesStatusGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: Array<handlers_WorkspaceCheckResponse>;
          };
        };
        examples: {};
      };
...
export type workspacesStatusGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspacesStatusGet_Headers = {
  /**
   * JWT Token
   */
