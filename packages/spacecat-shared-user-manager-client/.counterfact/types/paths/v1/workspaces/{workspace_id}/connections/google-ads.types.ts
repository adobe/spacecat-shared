...
/**
 * Creates a new Google Ads connection.
 */
export type adsConnectionCreate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: adsConnectionCreate_Path;
    headers: adsConnectionCreate_Headers;
    cookie: never;
...
export type adsConnectionCreate_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type adsConnectionCreate_Headers = {
  /**
   * JWT Token
   */
