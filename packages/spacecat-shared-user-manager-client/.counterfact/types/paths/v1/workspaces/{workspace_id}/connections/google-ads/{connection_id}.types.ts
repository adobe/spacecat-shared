...
import type { handlers_GoogleAdsWorkspaceConnectionCreate } from "../../../../../../definitions/handlers.GoogleAdsWorkspaceConnectionCreate.js";

/**
 * Updates an existing Google Ads connection.
 */
export type adsConnectionUpdate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: adsConnectionUpdate_Path;
    headers: adsConnectionUpdate_Headers;
    cookie: never;
    body: handlers_GoogleAdsWorkspaceConnectionCreate;
    context: Context;
...
export type adsConnectionUpdate_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type adsConnectionUpdate_Headers = {
  /**
   * JWT Token
   */
