...
import type { handlers_GoogleAnalyticsWorkspaceConnectionCreate } from "../../../../../definitions/handlers.GoogleAnalyticsWorkspaceConnectionCreate.js";

/**
 * Creates a new Google Analytics connection.
 */
export type analyticsConnectionCreate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: analyticsConnectionCreate_Path;
    headers: analyticsConnectionCreate_Headers;
    cookie: never;
    body: handlers_GoogleAnalyticsWorkspaceConnectionCreate;
    context: Context;
...
export type analyticsConnectionCreate_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type analyticsConnectionCreate_Headers = {
  /**
   * JWT Token
   */
