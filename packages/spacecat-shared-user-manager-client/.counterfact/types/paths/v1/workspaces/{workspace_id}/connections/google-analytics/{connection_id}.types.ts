...
/**
 * Updates an existing Google Analytics connection.
 */
export type analyticsConnectionUpdate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: analyticsConnectionUpdate_Path;
...
export type analyticsConnectionUpdate_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type analyticsConnectionUpdate_Headers = {
  /**
   * JWT Token
   */
