...
/**
 * Creates a new Google Console connection.
 */
export type consoleConnectionCreate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: consoleConnectionCreate_Path;
    headers: consoleConnectionCreate_Headers;
    cookie: never;
...
export type consoleConnectionCreate_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type consoleConnectionCreate_Headers = {
  /**
   * JWT Token
   */
