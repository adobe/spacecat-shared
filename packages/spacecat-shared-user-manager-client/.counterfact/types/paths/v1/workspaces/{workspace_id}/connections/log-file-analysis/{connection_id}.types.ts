...
/**
 * Updates an existing Log File Analysis connection.
 */
export type logFileAnalysisConnectionUpdate = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: logFileAnalysisConnectionUpdate_Path;
    headers: logFileAnalysisConnectionUpdate_Headers;
    cookie: never;
...
export type logFileAnalysisConnectionUpdate_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type logFileAnalysisConnectionUpdate_Headers = {
  /**
   * JWT Token
   */
