 ...
 */
export type workspaceProjectConnections = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspaceProjectConnections_Path;
    headers: workspaceProjectConnections_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type workspaceProjectConnections_Path = {
  /**
   * workspace id
   */
  workspace_id: string;
...
export type workspaceProjectConnections_Headers = {
  /**
   * JWT Token
   */
