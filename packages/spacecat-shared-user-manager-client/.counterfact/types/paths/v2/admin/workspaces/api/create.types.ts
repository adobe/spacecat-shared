 ...
 */
export type activationPanelWorkspaceCreateMasterV2 = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: never;
    headers: activationPanelWorkspaceCreateMasterV2_Headers;
    cookie: never;
...
export type activationPanelWorkspaceCreateMasterV2_Headers = {
  /**
