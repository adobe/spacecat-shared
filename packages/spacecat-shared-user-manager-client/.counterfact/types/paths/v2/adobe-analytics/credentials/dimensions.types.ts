...
/**
 * Gets Adobe dimensions by internal credential_id with ownership check.
 */
export type adobeAnalyticsGetDimensionsV2 = (
  $: OmitValueWhenNever<{
    query: adobeAnalyticsGetDimensionsV2_Query;
    querystring: never;
    path: never;
    headers: adobeAnalyticsGetDimensionsV2_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type adobeAnalyticsGetDimensionsV2_Query = {
  /**
...
export type adobeAnalyticsGetDimensionsV2_Headers = {
  /**
   * JWT Token
   */
