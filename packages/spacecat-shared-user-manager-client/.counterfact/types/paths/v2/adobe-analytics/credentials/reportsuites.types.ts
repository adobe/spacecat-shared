...
/**
 * Gets Adobe report suites by internal credential_id with ownership check.
 */
export type adobeAnalyticsGetReportSuitesV2 = (
  $: OmitValueWhenNever<{
    query: adobeAnalyticsGetReportSuitesV2_Query;
    querystring: never;
    path: never;
    headers: adobeAnalyticsGetReportSuitesV2_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type adobeAnalyticsGetReportSuitesV2_Query = {
  /**
...
export type adobeAnalyticsGetReportSuitesV2_Headers = {
  /**
   * JWT Token
   */
