...
import type { handlers_workspaceIDsResponse } from "../../../../../definitions/handlers.workspaceIDsResponse.js";
import type { http_server_BasicResponse } from "../../../../../definitions/http_server.BasicResponse.js";

/**
 * internal API to get workspace IDs that have the specified product.
 */
export type internalProductWorkspacesGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: internalProductWorkspacesGet_Path;
    headers: internalProductWorkspacesGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_workspaceIDsResponse;
          };
        };
        examples: {};
      };
...
export type internalProductWorkspacesGet_Path = {
  /**
   * product id (ai, si, ci, seo)
   */
  product_id: string;
};

export type internalProductWorkspacesGet_Headers = {
  /**
   * API key
   */
  "API-Key": string;
