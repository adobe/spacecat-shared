...
import type { handlers_TransactionsRefundForm } from "../../../../../definitions/handlers.TransactionsRefundForm.js";
...
/**
 * Cancel a transaction and refund the amount
 */
export type transactionRefundV2 = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: transactionRefundV2_Path;
    headers: transactionRefundV2_Headers;
    cookie: never;
    body: handlers_TransactionsRefundForm;
    context: Context;
...
export type transactionRefundV2_Path = {
  /**
   * transaction id
   */
...
export type transactionRefundV2_Headers = {
  /**
   * API key
   */
  "API-Key": string;
