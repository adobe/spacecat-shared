...
/**
 * Gets a list of all workspaces based on product filter.
 */
export type internalWorkspacesAllListV2 = (
  $: OmitValueWhenNever<{
    query: internalWorkspacesAllListV2_Query;
    querystring: never;
    path: never;
    headers: internalWorkspacesAllListV2_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalWorkspacesAllListV2_Query = {
  /**
   * Comma-separated list of product identifiers (e.g., ci,si)
   */
  products?: string;
};

export type internalWorkspacesAllListV2_Headers = {
  /**
   * API key
   */
  "API-Key": string;
