...
/**
 * an admin API to get a list of all children, grand children workspaces of a given workspace
 */
export type internalWorkspacesFamilyV2 = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: internalWorkspacesFamilyV2_Path;
    headers: internalWorkspacesFamilyV2_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type internalWorkspacesFamilyV2_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type internalWorkspacesFamilyV2_Headers = {
  /**
   * API key
   */
  "API-Key": string;
