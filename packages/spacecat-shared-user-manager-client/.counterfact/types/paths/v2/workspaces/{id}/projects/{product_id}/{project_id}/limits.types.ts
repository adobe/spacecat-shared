 ...
 */
export type projectLimitsGetV2 = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: projectLimitsGetV2_Path;
    headers: projectLimitsGetV2_Headers;
    cookie: never;
    body: never;
    context: Context;
...
export type projectLimitsGetV2_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type projectLimitsGetV2_Headers = {
  /**
   * JWT Token
   */
