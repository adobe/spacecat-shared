...
import type { handlers_workspaceUserAPIKey } from "../../../definitions/handlers.workspaceUserAPIKey.js";
import type { http_server_BasicResponse } from "../../../definitions/http_server.BasicResponse.js";

/**
 * This API gets workspace's owner API key, this API can be used by admin/owner of workspace
 * other users can't get admin's API
 * 400 is returned if user email is not passed in query
 */
export type workspaceOwnerApiKeyGet = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: workspaceOwnerApiKeyGet_Path;
    headers: workspaceOwnerApiKeyGet_Headers;
    cookie: never;
    body: never;
    context: Context;
    response: ResponseBuilderFactory<{
      200: {
        ...
        content: {
          "application/json": {
            schema: handlers_workspaceUserAPIKey;
          };
        };
        examples: {};
      };
...
export type workspaceOwnerApiKeyGet_Path = {
  /**
   * workspace id
   */
  id: string;
...
export type workspaceOwnerApiKeyGet_Headers = {
  /**
   * JWT Token
   */
