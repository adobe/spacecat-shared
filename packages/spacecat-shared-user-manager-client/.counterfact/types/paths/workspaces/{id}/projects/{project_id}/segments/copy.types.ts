...
import type { handlers_CopySegmentsRequest } from "../../../../../../definitions/handlers.CopySegmentsRequest.js";
import type { http_server_BasicResponse } from "../../../../../../definitions/http_server.BasicResponse.js";

/**
 * Copy specified segments from current project to other projects within the same workspace
 */
export type segmentsCopyToProjects = (
  $: OmitValueWhenNever<{
    query: never;
    querystring: never;
    path: segmentsCopyToProjects_Path;
    headers: segmentsCopyToProjects_Headers;
    cookie: never;
    body: handlers_CopySegmentsRequest;
    context: Context;
...
export type segmentsCopyToProjects_Path = {
  /**
   * Workspace ID
   */
  id: string;
...
export type segmentsCopyToProjects_Headers = {
  /**
   * JWT Token
   */
